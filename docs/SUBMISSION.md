...
**Demo video (YouTube):** https://youtu.be/bVOmMBCdGAs - 2:22, real screen capture of the live app functioning, footage-first, answering the three judge questions: problem, for whom, and why (source: `docs/veritas-demo-live.mp4`)
